 ...
 */
@com.vaadin.ui.ClientWidget(org.vaadin.smartgwt.client.ui.VSelectItem.class)
public class SelectItem extends FormItem
{
	public SelectItem()
	{
		...
		// setHint("<nobr>A combobox with styled entries</nobr>");
		// setValueMap("<span style='color:#FF0000;'>Red</span>",
	...
	/**
	 * If we're setting the value of a select item and the value isn't a legal value in the valueMap, whether we should allow the value (creating a new option
	 * for it) or reject it.
	 * <P>
	 * Exception: If the value is set to <code>null</code> but there is no null entry in the valueMap for this item, setting <code>addUnknownValues</code> to
	 * true will not cause a null option to show up at the top of the select item pickList. Whether an empty option is shown in the pickList is governed by
	 * {@link com.smartgwt.client.widgets.form.fields.SelectItem#getAllowEmptyValue allowEmptyValue} instead.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param addUnknownValues
	...
	/**
	 * If set to true, always show an empty option in this item's pickList, allowing the user to clear the value (even if there is no empty entry in the
	 * valueMap for the item).
	 * <P>
	 * The empty value will be displayed with the {@link com.smartgwt.client.widgets.form.fields.FormItem#getEmptyDisplayValue emptyDisplayValue}.
	 * <P>
	 * With a {@link com.smartgwt.client.widgets.form.fields.SelectItem#getOptionDataSource databound selectItem}, enabling <code>allowEmptyValue</code>
	 * disables data paging - all data matching the current criteria will be requested.
	 * 
	...
	/**
	 * If this select item retrieves its options from a <code>dataSource</code>, should options be fetched from the server when the item is first drawn, or
	 * should this fetch be delayed until the user opens the pickList.
	 * <P>
	 * The default is true in order to allow the user to select a value via keyboard input while keyboard focus is on the SelectItem but the pickList has not
	 * actually been shown.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 ...
	 * 
	 * @param controlStyle
	 *            controlStyle Default value is "selectItemControl", [IRA]
	 ...
	 * <P>
	 * If options are derived from a dataSource, the first value returned by the server will be used, otherwise the first value in the valueMap. Note that
	 * setting this property to true will trigger a fetch at soon as the form is created, because the form will try to establish a default value at that time.
	 * <P>
	 * If enabled, this setting overrides {@link com.smartgwt.client.widgets.form.fields.SelectItem#getDefaultValue defaultValue} and
	 * {@link com.smartgwt.client.widgets.form.fields.SelectItem#defaultDynamicValue SelectItem.defaultDynamicValue}.
	 * 
	 * @param defaultToFirstOption
	 ...
	 * {@link com.smartgwt.client.widgets.form.fields.SelectItem#getDefaultToFirstOption defaultToFirstOption} instead.
	 * 
	 * @param defaultValue
	...
	/**
	 * If <code>filterLocally</code> is set for this item, and this item is showing options from a dataSource, fetch the entire set of options from the server,
	 * and use these values to map the item value to the appropriate display value. Also use <code>"local"</code> type filtering on drop down list of options.
	 * <P>
	 ...
	 * <P>
	 * The SelectItem will either render as a drop-down allowing multiple selections, or a multi-row list of options similar to a small headerless
	 * {@link com.smartgwt.client.widgets.grid.ListGrid}, based on the {@link com.smartgwt.client.types.MultipleAppearance} setting.
	 * <P>
	 * The logical value of the formItem, as retrieved by {@link com.smartgwt.client.widgets.form.fields.FormItem#getValue getValue()} and set via
	 * {@link com.smartgwt.client.widgets.form.fields.FormItem#setValue setValue()}, is an Array of Strings reflecting the selected values.
	 * <P>
	 * When this value is true, we disable doubleClick events by default, instead issuing two single clicks by forcibly setting
	 * {@link com.smartgwt.client.widgets.Canvas#getNoDoubleClicks noDoubleClicks: true}. If you need to work with doubleClick events, you can disable this
	 * default behavior by explicitly setting formItem.pickListProperties.noDoubleClicks: false.
	 * <P>
	 * Note: <code>multiple:true</code> SelectItems do not currently support optionDataSource binding. You can get around this by calling
	 * {@link com.smartgwt.client.data.DataSource#fetchData DataSource.fetchData} directly and calling {@link com.smartgwt.client.data.List#getValueMap
	...
	/**
	 * How should items with {@link com.smartgwt.client.widgets.form.fields.SelectItem#getMultiple multiple} set to 'true' be displayed?
	 * 
	 * @param multipleAppearance
	...
	/**
	 * If {@link com.smartgwt.client.widgets.form.fields.SelectItem#getShowPickerIcon showPickerIcon} is true for this item, this property governs the size of
	 * the picker icon. If unset, the picker icon will be sized as a square to fit in the available height for the icon.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	...
	/**
	 * If {@link com.smartgwt.client.widgets.form.fields.SelectItem#getShowPickerIcon showPickerIcon} is true for this item, this property governs the src of
	 * the picker icon image to be displayed.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param pickerIconSrc
	 *            pickerIconSrc Default value is "[SKIN]/DynamicForm/SelectItem_PickButton_icon.gif"
	 */
	 ...
	 * 
	 * @param pickerIconStyle
	 *            pickerIconStyle Default value is "selectItemPickerIcon", [IRA]
	 ...
	 * <P>
	 * CSS style for the hint is {@link com.smartgwt.client.widgets.form.fields.SelectItem#getTextBoxStyle textBoxStyle} with the suffix "Hint" appended to it.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param showHintInField
	...
	/**
	 * If this item is part of a databound form, and has a specified <code>valueMap</code>, by default we show the valueMap options in the pickList for the
	 * item. Setting this property to true will ensure that the options displayed in our pickList are derived from the form's <code>dataSource</code>.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param showOptionsFromDataSource
	...
	/**
	 * Should we show a special 'picker' icon for this form item. Picker icons are customizable via
	 * {@link com.smartgwt.client.widgets.form.fields.SelectItem#getPickerIconProperties pickerIconProperties}. By default they will be rendered inside the Form
	 * Item's "control box" area, and will call {@link com.smartgwt.client.widgets.form.fields.SelectItem#showPicker SelectItem.showPicker} when clicked.
	 * 
	 ...
	 * 
	 * @param textBoxStyle
	 *            textBoxStyle Default value is "selectItemText", [IRA]
	 * @see com.smartgwt.client.widgets.form.fields.FormItem#setCellStyle
	 * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
	 */
	 ...
	 * <P>
	 * For a databound pickList ({@link com.smartgwt.client.widgets.form.fields.SelectItem#getOptionDataSource optionDataSource} set),
	 * <code>textMatchStyle</code> is sent to the server as {@link com.smartgwt.client.data.DSRequest#getTextMatchStyle textMatchStyle}.
	 * <P>
	 * For a non-databound pickList, <code>textMatchStyle</code> is applied by
	 * {@link com.smartgwt.client.widgets.form.fields.SelectItem#getFilterClientPickListData filterClientPickListData}.
	 * 
	 ...
	 * <P>
	 * Only applies to databound pickLists (see {@link com.smartgwt.client.widgets.form.fields.PickList#getOptionDataSource optionDataSource}, or picklists with
	 * custom data set up via the advanced {@link com.smartgwt.client.widgets.form.fields.PickList#getClientPickListData} method.
	 * <P>
	 * If this property is unset, we display the {@link com.smartgwt.client.widgets.form.fields.PickList#getDisplayField displayField}, if specified, otherwise
	 * the {@link com.smartgwt.client.widgets.form.fields.PickList#getValueField valueField}
	 * <P>
	 * If there are multiple fields, column headers will be shown for each field, the height of which can be customized via the
	 * {@link com.smartgwt.client.widgets.form.fields.PickList#getPickListHeaderHeight pickListHeaderHeight} attribute.
	 * <P>
	 * Each field to display should be specified as a {@link com.smartgwt.client.widgets.grid.ListGridField} object. Note that unlike in
	 * {@link com.smartgwt.client.widgets.grid.ListGrid}, dataSource fields marked as {@link com.smartgwt.client.data.DataSourceField#setDis$
	 * isc.DocUtils.linkForRef('DataSourceField.display','display:true')} will not be hidden by default in pickLists. To override this behavior, ensure that you
	 * specify an explicit value for {@link com.smartgwt.client.widgets.grid.ListGridField#getShowIf showIf}
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 ...
	 * it will be taller when more rows are available as selectable options
	 * 
	 * @param pickListHeight
	 ...
	 * {@link com.smartgwt.client.widgets.form.fields.PickList#getHideEmptyPickList hideEmptyPickList} is <code>false</code>.
	 * 
	 * @param emptyPickListHeight
	...
	/**
	 * Empty message to display in the pickList if {@link com.smartgwt.client.widgets.form.fields.PickList#getHideEmptyPickList hideEmptyPickList} is
	 * <code>false</code>.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param emptyPickListMessage
	 *            emptyPickListMessage Default value is null
	 */
	...
	/**
	 * If this pick list is showing multiple fields, this property determines the height of the column headers for those fields. Set to zero to suppress the
	 * headers entirely.
	 * 
	 * @param pickListHeaderHeight
	...
	/**
	 * Specifies the field by which this item should be initially sorted. Can be set to either a {@link com.smartgwt.client.widgets.grid.ListGridField#getName
	 * 'field name'} or the index of the field in the fields Array. Note that if <code>sortField</code> is initally specified as a number, it will be converted
	 * to a string (field name) after the item is initialized.
	 * <P>
	...
	/**
	 * For Databound formItems, this property determines which column {@link com.smartgwt.client.widgets.form.fields.FormItem#getValueIcons valueIcons} should
	 * show up in for this formItem's pickList.<br>
	 * If unset valueIcons show up in the {@link com.smartgwt.client.widgets.form.fields.PickList#getDisplayField displayField} column if specified, otherwise
	 * the {@link com.smartgwt.client.widgets.form.fields.PickList#getValueField valueField} column.<br>
	 * In most cases only the <code>displayField</code> or <code>valueField</code> will be visible. This property is typically only required if custom
	 * {@link com.smartgwt.client.widgets.form.fields.PickList#getPickListFields pickListFields} have been specfied for this item.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param valueIconField
	...
	/**
	 * If this item has a databound pick-list (for example {@link com.smartgwt.client.widgets.form.fields.PickList#getOptionDataSource optionDataSource} is set)
	 * this property can be used to provide static filter criteria when retrieving the data for the pickList.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param pickListCriteria
	 ...
	 * separatorRows} in between. Not valid for {@link com.smartgwt.client.widgets.form.fields.PickList#getOptionDataSource optionDataSource}.
	 * 
	 * @param showAllOptions
	 *            showAllOptions Default value is null
	 */
	...
	/**
	 * If this item has a specified <code>optionDataSource</code>, and this property is not null, this will be passed to the datasource as
	 * {@link com.smartgwt.client.rpc.RPCRequest} properties when performing the filter operation on the dataSource to obtain the set of options for the list.
	 * <p>
	 * <b>Note : </b> This is an advanced setting
	 * </p>
	 * 
	 * @param optionFilterContext
	...
	/**
	 * Default values used when no value is provided for this item. Note that whenever this item's value is cleared by the user or set to <code>null</code>
	 * programatically, it will be reverted to the <code>defaultValues</code>.
	 * 
	 * @param defaultValues
