...
public enum CriteriaPolicy implements ValueEnum
{
	...
	/**
	 * Cache is retained as along as the only changes to criteria are lengthening of criteria values for known, String-valued&#010 DataSource fields, or the
	 * addition of fields that weren't&#010 present before.
	 */
