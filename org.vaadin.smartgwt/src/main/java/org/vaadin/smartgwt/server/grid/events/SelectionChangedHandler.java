...
public interface SelectionChangedHandler extends EventHandler {
	 ...
	 * triggering selection-oriented events within an application, see the 
	 * {@link com.smartgwt.client.widgets.DataBoundComponent#selectionUpdated selectionUpdated} event which is likely more suitable.
	 *
