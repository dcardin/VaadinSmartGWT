	...
	public static CountryRecord[] getNewRecords() {
		return new CountryRecord[]{
				...
				new CountryRecord(
						...
						33098932,
						1114,
						new Date(1867 - 1900, 6, 1),
						"constitutional monarchy with parliamentary democracy and federation",
						1,
						"Ottawa",
						true,
